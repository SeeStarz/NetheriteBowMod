...
public class ArrowEntity extends AbstractArrowEntity implements IEntityAdditionalSpawnData {
    ...
    public ArrowEntity(World worldIn, double x, double y, double z) {
        super(ModEntityType.ARROW.get(), x, y, z, worldIn);
    }
    public ArrowEntity(EntityType<? extends AbstractArrowEntity> type, World worldIn) {
        super(type, worldIn);
    }

    public ArrowEntity(World worldIn, LivingEntity shooter) {
        super(ModEntityType.ARROW.get(), shooter, worldIn);
    }
